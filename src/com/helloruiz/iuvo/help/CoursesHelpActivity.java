...
public class CoursesHelpActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView textView;
		textView = (TextView) findViewById(R.id.courses_help_title_textview); textView.setTypeface(IuvoApplication.typeface);
	}

	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.courses_help, menu);
		return true;
	}
